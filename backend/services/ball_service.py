...
class BallService:
    ...
    def process_ball_data(self, data):
        ...
        # Save processed data
        self.ball_storage_layer.save_original_as_json(filtered_ball_info, "ball_data.json")
        self.ball_storage_layer.save_rim_original_as_json(filtered_rim_info, "rim_data.json")
