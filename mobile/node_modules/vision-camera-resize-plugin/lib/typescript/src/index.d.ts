...
export type OutputArray<T extends DataType> = T extends 'uint8' ? Uint8Array : T extends 'float32' ? Float32Array : never;
interface Size {
    /**
 ...
 */
export declare function createResizePlugin(): ResizePlugin;
/**
 ...
 */
export declare function useResizePlugin(): ResizePlugin;
export {};
