...
const MainScreen = ({navigation}) => {
  ...
  const stopRecording = () => {
    ...
    // Call the finishProcess function to finalize the recording
    finishProcess();

    // Navigate to the results screen (if applicable)
    navigation.navigate('Results'); // Ensure 'Results' is defined in your navigation stack
  };
