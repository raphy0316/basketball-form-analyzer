...
variant_for_slice()
{
  ...
  "libskottie.xcframework/ios-arm64_arm64e_x86_64-simulator")
    echo "simulator"
    ;;
  "libskottie.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "libskottie.xcframework/tvos-arm64_arm64e")
    echo ""
    ;;
  "libskottie.xcframework/tvos-arm64_arm64e_x86_64-simulator")
    echo "simulator"
    ;;
  ...
  "libsksg.xcframework/ios-arm64_arm64e_x86_64-simulator")
    echo "simulator"
    ;;
  "libsksg.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "libsksg.xcframework/tvos-arm64_arm64e")
    echo ""
    ;;
  "libsksg.xcframework/tvos-arm64_arm64e_x86_64-simulator")
    echo "simulator"
    ;;
  "libpathops.xcframework/ios-arm64_arm64e")
    echo ""
    ;;
  "libpathops.xcframework/ios-arm64_arm64e_x86_64-simulator")
    echo "simulator"
    ;;
  "libpathops.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "libpathops.xcframework/tvos-arm64_arm64e")
    echo ""
    ;;
  "libpathops.xcframework/tvos-arm64_arm64e_x86_64-simulator")
    echo "simulator"
    ;;
  esac
}
...
install_xcframework "${PODS_ROOT}/../../node_modules/@shopify/react-native-skia/libs/apple/libskottie.xcframework" "react-native-skia" "library" "ios-arm64_arm64e" "ios-arm64_arm64e_x86_64-simulator"
install_xcframework "${PODS_ROOT}/../../node_modules/@shopify/react-native-skia/libs/apple/libsksg.xcframework" "react-native-skia" "library" "ios-arm64_arm64e" "ios-arm64_arm64e_x86_64-simulator"
install_xcframework "${PODS_ROOT}/../../node_modules/@shopify/react-native-skia/libs/apple/libpathops.xcframework" "react-native-skia" "library" "ios-arm64_arm64e" "ios-arm64_arm64e_x86_64-simulator"
